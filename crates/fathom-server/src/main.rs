...
fn catalog_specs() -> Vec<CatalogModelSpec> {
    vec![
        ...
        CatalogModelSpec {
            catalog_id: "hf-qwen-qwen2-5-0-5b-instruct",
            title: "Qwen2.5 0.5B Instruct",
            repo_id: "Qwen/Qwen2.5-0.5B-Instruct",
            revision: Some("7ae557604adf67be50417f59c2c2f167def9a775"),
            primary_filename: "model.safetensors",
            files: vec![
                catalog_file("config.json", 659, "18e18afcaccafade98daf13a54092927904649e1dd4eba8299ab717d5d94ff45"),
                catalog_file("generation_config.json", 242, "e558847a8b4402616f1273797b015104dc266fe4b520056fca88823ba8f8ebe6"),
                catalog_file("merges.txt", 1_671_839, "599bab54075088774b1733fde865d5bd747cbcc7a547c5bc12610e874e26f5e3"),
                catalog_file("model.safetensors", 988_097_824, "fdf756fa7fcbe7404d5c60e26bff1a0c8b8aa1f72ced49e7dd0210fe288fb7fe"),
                catalog_file("tokenizer.json", 7_031_645, "c0382117ea329cdf097041132f6d735924b697924d6f6fc3945713e96ce87539"),
                catalog_file("tokenizer_config.json", 7_305, "5b5d4f65d0acd3b2d56a35b56d374a36cbc1c8fa5cf3b3febbbfabf22f359583"),
                catalog_file("vocab.json", 2_776_833, "ca10d7e9fb3ed18575dd1e277a2579c16d108e32f27439684afa0e10b1440910"),
                catalog_file("LICENSE", 11_343, "832dd9e00a68dd83b3c3fb9f5588dad7dcf337a0db50f7d9483f310cd292e92e"),
            ],
            size_bytes: Some(999_597_690),
            license: "apache-2.0",
            description: "Real Qwen2.5 0.5B Instruct SafeTensors/HF chat-tuned demo for Fathom's verified Qwen2 lane. It is larger than TinyStories and uses a tied-output checkpoint; it remains a pinned optional catalog demo, not general Qwen or arbitrary Hugging Face support.",
        },
        CatalogModelSpec {
