...
- The offline public API contract QA and CI static policy gates require default CI to run both the public risk scan self-test and the tracked-file public risk scan.
