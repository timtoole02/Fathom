...
def assert_boundary_docs() -> None:
    ...
    assert_contains(
        launch_text,
        "Astro `.astro/`, Docusaurus `.docusaurus/`, VitePress `.vitepress/cache/` and `.vitepress/dist/`, Next.js `.next/`, SvelteKit `.svelte-kit/`, Nuxt `.nuxt/` and `.output/`, and Angular `.angular/cache/` directories",
    ...
    assert_contains(
        evidence_text,
        "Astro/Docusaurus/VitePress/Next.js/SvelteKit/Nuxt/Angular framework cache/build outputs such as `.astro/`, `.docusaurus/`, `.vitepress/cache/`, `.vitepress/dist/`, `.next/`, `.svelte-kit/`, `.nuxt/`, `.output/`, and `.angular/cache/`",
