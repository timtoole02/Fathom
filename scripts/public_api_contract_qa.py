...
def assert_public_contract_smoke_artifact_wiring() -> None:
    ...
    assert_contains(
        artifact_qa_text,
        "manifest line must match summary.manifest.path",
        "public contract smoke artifact QA manifest path markdown guard",
    )
    assert_contains(
        artifact_qa_text,
    ...
    assert_contains(
        artifact_qa_text,
        "manifest name drift self-check did not fail",
        "public contract smoke artifact QA manifest name negative self-test",
    )
    assert_contains(
        artifact_qa_text,
    ...
    assert_contains(
        artifact_qa_text,
        "boundary check must name a check id",
        "public contract smoke artifact QA boundary check-id schema guard",
    )
    assert_contains(
        artifact_qa_text,
