...
required_code_quality_artifact_gitignore_patterns = {
    ...
    "tsc-results-*.txt",
    "tsc-results-*.xml",
    "typecheck-report.html",
    "typecheck-report.json",
    "typecheck-report.txt",
    "typecheck-report.xml",
    "typecheck-report-*.html",
    "typecheck-report-*.json",
    "typecheck-report-*.txt",
    "typecheck-report-*.xml",
    ...
    "typecheck-results.xml",
    "typecheck-results-*.json",
    "typecheck-results-*.txt",
    "typecheck-results-*.xml",
    "typescript-report.html",
    "typescript-report.json",
    "typescript-report.txt",
    "typescript-report.xml",
    "typescript-report-*.html",
    "typescript-report-*.json",
    "typescript-report-*.txt",
    "typescript-report-*.xml",
...
required_test_report_artifact_gitignore_patterns = {
    ...
    "biome-results-*.json",
    "biome-results-*.xml",
    "markdownlint-junit.xml",
    "markdownlint-report.html",
    ...
    "markdownlint-results.xml",
    "markdownlint-results-*.json",
    "markdownlint-results-*.xml",
    "proselint-junit.xml",
    "proselint-report.html",
    "proselint-report.json",
    "proselint-report.xml",
    "proselint-report-*.html",
    "proselint-report-*.json",
    "proselint-report-*.xml",
    "proselint-results.json",
    "proselint-results.xml",
    "proselint-results-*.json",
    "proselint-results-*.xml",
    "remark-junit.xml",
    "remark-report.html",
    ...
    "gotestsum.json",
    "gotestsum-report.json",
    "gotestsum-report.xml",
    "go-test-report.json",
    "go-test-report.xml",
    "go-test-results.json",
    "go-test-results.xml",
...
required_security_scan_report_artifact_gitignore_patterns = {
    ...
    "cargo-audit-report.xml",
    "cargo-audit-report-*.json",
    "cargo-audit-report-*.txt",
    "cargo-audit-report-*.xml",
    "cargo-audit-results.json",
    "cargo-audit-results.txt",
    "cargo-audit-results.xml",
    "cargo-audit-results-*.json",
    "cargo-audit-results-*.txt",
    "cargo-audit-results-*.xml",
    "cargo-deny-report.json",
    "cargo-deny-report.txt",
    "cargo-deny-report.xml",
    "cargo-deny-report-*.json",
    "cargo-deny-report-*.txt",
    "cargo-deny-report-*.xml",
    "cargo-deny-results.json",
    "cargo-deny-results.txt",
    "cargo-deny-results.xml",
    "cargo-deny-results-*.json",
    "cargo-deny-results-*.txt",
    "cargo-deny-results-*.xml",
    "codeql-report.json",
...
def self_test():
    ...
    local_ci_artifact_failures = tracked_local_ci_artifact_file_failures(
        tracked_paths=[
            ...
            "actions-runner/_temp/runner_file_commands/set_env_123",
            "actions-runner/_tool/node/20.0.0/x64/bin/node",
            "services/api/_work/_temp/state.json",
            "services/api/_temp/action_state.json",
            "services/api/_tool/rust/1.88.0/bin/rustc",
            ".runner",
            ".credentials",
            ".credentials_rsaparams",
            "docs/api/public-contract.json",
    ...
    if local_ci_artifact_failures != [
        ...
        "actions-runner/_temp/runner_file_commands/set_env_123: local CI runner artifacts must not be tracked for public launch",
        "actions-runner/_tool/node/20.0.0/x64/bin/node: local CI runner artifacts must not be tracked for public launch",
        "services/api/_work/_temp/state.json: local CI runner artifacts must not be tracked for public launch",
        "services/api/_temp/action_state.json: local CI runner artifacts must not be tracked for public launch",
        "services/api/_tool/rust/1.88.0/bin/rustc: local CI runner artifacts must not be tracked for public launch",
    ...
    code_quality_typecheck_gitignore_failures = gitignore_code_quality_artifact_failures(
        allowed_code_quality_artifact_gitignore.replace("tsc-report.txt\n", "", 1)
    )
    if code_quality_typecheck_gitignore_failures != [
        ".gitignore: missing local code-quality scanner/report artifact ignore patterns: tsc-report.txt"
    ]:
        raise AssertionError("public risk self-test did not reject missing local TypeScript type-check report ignore patterns")
    code_quality_artifact_failures = tracked_code_quality_artifact_file_failures(
        tracked_paths=[
            ...
            "tsc-report.txt",
            "frontend/tsc-reports/results.json",
            "typecheck-report-public-risk.html",
            "typescript-results-public-risk.xml",
            ".semgrep.yml",
            "semgrep.yml",
    ...
    if code_quality_artifact_failures != [
        ...
        "tsc-report.txt: local code-quality scanner/report artifacts must not be tracked for public launch",
        "frontend/tsc-reports/results.json: local code-quality scanner/report artifacts must not be tracked for public launch",
        "typecheck-report-public-risk.html: local code-quality scanner/report artifacts must not be tracked for public launch",
        "typescript-results-public-risk.xml: local code-quality scanner/report artifacts must not be tracked for public launch",
    ]:
    ...
    frontend_artifact_failures = tracked_frontend_artifact_file_failures(
        tracked_paths=[
            ...
            "bundle-analyzer-report.html",
            "bundle-analysis-public-risk.json",
            "frontend/bundle-stats.html",
            "examples/web/webpack-stats-public-risk.json",
            "rollup-stats.html",
            "vite-bundle-visualizer-public-risk.html",
            "bun-debug.log",
            "npm-debug.log",
            "yarn-error.log",
            "pnpm-debug.log",
    ...
    if frontend_artifact_failures != [
        ...
        "bundle-analyzer-report.html: frontend/Node cache/build artifacts must not be tracked for public launch",
        "bundle-analysis-public-risk.json: frontend/Node cache/build artifacts must not be tracked for public launch",
        "frontend/bundle-stats.html: frontend/Node cache/build artifacts must not be tracked for public launch",
        "examples/web/webpack-stats-public-risk.json: frontend/Node cache/build artifacts must not be tracked for public launch",
        "rollup-stats.html: frontend/Node cache/build artifacts must not be tracked for public launch",
        "vite-bundle-visualizer-public-risk.html: frontend/Node cache/build artifacts must not be tracked for public launch",
    ...
    test_report_artifact_failures = tracked_test_report_artifact_file_failures(
        tracked_paths=[
            ...
            "axe-reports/results.json",
            "biome-report/index.html",
            "biome-reports/results.json",
            "markdownlint-report/index.html",
            "markdownlint-reports/results.json",
            "mochawesome-report/mochawesome.html",
            "newman/summary.json",
            "proselint-report/index.html",
            "proselint-reports/results.json",
            "remark-report/index.html",
            "remark-reports/results.json",
            ...
            "examples/web/axe-report/index.html",
            "examples/web/pa11y-reports/results.json",
            "examples/web/biome-report/index.html",
            "examples/web/biome-reports/results.json",
            "examples/web/markdownlint-report/index.html",
            "examples/web/markdownlint-reports/results.json",
            "examples/web/mochawesome-report/mochawesome.json",
            "examples/web/newman/report.html",
            "examples/web/proselint-report/index.html",
            "examples/web/proselint-reports/results.json",
            "examples/web/remark-report/index.html",
            "examples/web/remark-reports/results.json",
            "examples/web/robot-results/log.html",
            "examples/web/robot-reports/output.xml",
            "examples/web/k6-report/index.html",
            "examples/web/k6-reports/summary.json",
            "examples/web/artillery-report/index.html",
            "examples/web/artillery-reports/results.json",
            "examples/web/locust-report/index.html",
            "examples/web/locust-reports/stats.csv",
            "examples/web/jmeter-report/index.html",
            "examples/web/jmeter-reports/index.html",
            "examples/web/jmeter-results/results.jtl",
            "examples/web/jest-html-reporters-attach/screenshot.png",
            "examples/web/jest-stare/index.html",
            "examples/web/junit-report/index.html",
            "examples/web/junit-reports/results.xml",
            "examples/web/eslint-report/index.html",
            "examples/web/eslint-reports/results.json",
            "examples/web/stylelint-report/index.html",
            "examples/web/stylelint-reports/results.json",
            "examples/web/vitest-report/index.html",
            "examples/web/tap-report/index.html",
            "examples/web/tap-reports/results.tap",
            "examples/web/cucumber-report/index.html",
            "examples/web/cucumber-reports/cucumber.xml",
            "examples/web/ctrf/ctrf-report.json",
            ...
            "services/api/test-output/emailable-report.html",
            "services/api/ctrf/ctrf-report.json",
            ...
            "axe-report.json",
            "axe-report.xml",
            "axe-report-public-risk.html",
            "axe-results.json",
            "axe-results-public-risk.json",
            "biome-report.html",
            "biome-report.json",
            "biome-report.xml",
            "biome-report-public-risk.html",
            "biome-report-public-risk.json",
            "biome-report-public-risk.xml",
            "biome-results.json",
            "biome-results.xml",
            "biome-results-public-risk.json",
            "biome-results-public-risk.xml",
            "markdownlint-junit.xml",
            "markdownlint-report.html",
            "markdownlint-report.json",
            "markdownlint-report.xml",
            "markdownlint-report-public-risk.html",
            "markdownlint-report-public-risk.json",
            "markdownlint-report-public-risk.xml",
            "markdownlint-results.json",
            "markdownlint-results.xml",
            "markdownlint-results-public-risk.json",
            "markdownlint-results-public-risk.xml",
            "proselint-junit.xml",
            "proselint-report.html",
            "proselint-report.json",
            "proselint-report.xml",
            "proselint-report-public-risk.html",
            "proselint-report-public-risk.json",
            "proselint-report-public-risk.xml",
            "proselint-results.json",
            "proselint-results.xml",
            "proselint-results-public-risk.json",
            "proselint-results-public-risk.xml",
            "remark-junit.xml",
            "remark-report.html",
            "remark-report.json",
            "remark-report.xml",
            "remark-report-public-risk.html",
            "remark-report-public-risk.json",
            "remark-report-public-risk.xml",
            "remark-results.json",
            "remark-results.xml",
            "remark-results-public-risk.json",
            "remark-results-public-risk.xml",
            "coverage-final.json",
            "coverage-summary.json",
            "codecov.json",
            "clover.xml",
            "client.coveralls.json",
            "coverage.clover.xml",
            "coverage.codecov.json",
            "cobertura.xml",
            "coverage.coveralls.json",
            "coverage.cobertura.xml",
            "ctrf-report.json",
            "ctrf-report-public-risk.json",
            "opencover.xml",
            ...
            "eslint-report.json",
            "eslint-report.xml",
            "eslint-report-public-risk.html",
            "eslint-report-public-risk.json",
            "eslint-report-public-risk.xml",
            "eslint-results.json",
            "eslint-results.xml",
            "eslint-results-public-risk.json",
            "eslint-results-public-risk.xml",
            "stylelint-junit.xml",
            "stylelint-report.html",
            "stylelint-report.json",
            "stylelint-report.xml",
            "stylelint-report-public-risk.html",
            "stylelint-report-public-risk.json",
            "stylelint-report-public-risk.xml",
            "stylelint-results.json",
            "stylelint-results.xml",
            "stylelint-results-public-risk.json",
            "stylelint-results-public-risk.xml",
            "vitest-junit.xml",
            "vitest-report.html",
            "vitest-report.json",
            "vitest-report-public-risk.html",
            "vitest-report-public-risk.json",
            "vitest-report-public-risk.xml",
            "vitest-results.json",
            ...
            "gotestsum.json",
            "gotestsum-report.xml",
            "services/api/go-test-report.json",
            "crates/fathom-core/go-test-results.xml",
            ...
            "TESTS-fathom.xml",
            "crates/fathom-core/TESTS-fathom.xml",
            "testng-results.xml",
            "crates/fathom-core/testng-failed.xml",
            "emailable-report.html",
            "nunit.xml",
            ...
            "tap-results.tap",
            "load-test.jtl",
            "crates/fathom-core/results.jtl",
            "crates/fathom-core/tap-report.json",
            "load-test.jmx",
            "biome.json",
            "biome.jsonc",
            ".markdownlint.json",
            ...
            "pytest-report.json",
            "pytest-report.xml",
            "pytest-report-public-risk.html",
            "pytest-report-public-risk.json",
            "pytest-report-public-risk.xml",
            "crates/fathom-core/pytest-report-public-risk.html",
            "pa11y-ci-report.html",
            "pa11y-ci-report.json",
            "pa11y-ci-report.xml",
            "pa11y-ci-report-public-risk.json",
            "pa11y-ci-results.json",
            "pa11y-ci-results-public-risk.json",
            "pa11y-report.html",
            "pa11y-report.json",
            "pa11y-report.xml",
            "pa11y-report-public-risk.html",
            "pa11y-results.json",
            "pa11y-results-public-risk.json",
            "axe.config.js",
            ".pa11yci",
            "pa11yci.json",
            "tarpaulin-report.html",
    ...
    if test_report_artifact_failures != [
        ...
        "axe-report/index.html: local test report artifacts must not be tracked for public launch",
        "axe-reports/results.json: local test report artifacts must not be tracked for public launch",
        "biome-report/index.html: local test report artifacts must not be tracked for public launch",
        "biome-reports/results.json: local test report artifacts must not be tracked for public launch",
        "markdownlint-report/index.html: local test report artifacts must not be tracked for public launch",
        "markdownlint-reports/results.json: local test report artifacts must not be tracked for public launch",
        "mochawesome-report/mochawesome.html: local test report artifacts must not be tracked for public launch",
        "newman/summary.json: local test report artifacts must not be tracked for public launch",
        "proselint-report/index.html: local test report artifacts must not be tracked for public launch",
        "proselint-reports/results.json: local test report artifacts must not be tracked for public launch",
        "remark-report/index.html: local test report artifacts must not be tracked for public launch",
        "remark-reports/results.json: local test report artifacts must not be tracked for public launch",
        "robot-results/output.xml: local test report artifacts must not be tracked for public launch",
        "robot-reports/report.html: local test report artifacts must not be tracked for public launch",
        ...
        "ctrf/ctrf-report.json: local test report artifacts must not be tracked for public launch",
        ...
        "examples/web/axe-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/pa11y-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/biome-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/biome-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/markdownlint-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/markdownlint-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/mochawesome-report/mochawesome.json: local test report artifacts must not be tracked for public launch",
        "examples/web/newman/report.html: local test report artifacts must not be tracked for public launch",
        "examples/web/proselint-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/proselint-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/remark-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/remark-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/robot-results/log.html: local test report artifacts must not be tracked for public launch",
        "examples/web/robot-reports/output.xml: local test report artifacts must not be tracked for public launch",
        "examples/web/k6-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/k6-reports/summary.json: local test report artifacts must not be tracked for public launch",
        "examples/web/artillery-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/artillery-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/locust-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/locust-reports/stats.csv: local test report artifacts must not be tracked for public launch",
        "examples/web/jmeter-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/jmeter-reports/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/jmeter-results/results.jtl: local test report artifacts must not be tracked for public launch",
        "examples/web/jest-html-reporters-attach/screenshot.png: local test report artifacts must not be tracked for public launch",
        "examples/web/jest-stare/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/junit-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/junit-reports/results.xml: local test report artifacts must not be tracked for public launch",
        "examples/web/eslint-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/eslint-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/stylelint-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/stylelint-reports/results.json: local test report artifacts must not be tracked for public launch",
        "examples/web/vitest-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/tap-report/index.html: local test report artifacts must not be tracked for public launch",
        "examples/web/tap-reports/results.tap: local test report artifacts must not be tracked for public launch",
        ...
        "examples/web/ctrf/ctrf-report.json: local test report artifacts must not be tracked for public launch",
        ...
        "test-output/testng-results.xml: local test report artifacts must not be tracked for public launch",
        ...
        "services/api/test-output/emailable-report.html: local test report artifacts must not be tracked for public launch",
        "services/api/ctrf/ctrf-report.json: local test report artifacts must not be tracked for public launch",
        ...
        "coverage.json: local test report artifacts must not be tracked for public launch",
        "axe-report.html: local test report artifacts must not be tracked for public launch",
        "axe-report.json: local test report artifacts must not be tracked for public launch",
        "axe-report.xml: local test report artifacts must not be tracked for public launch",
        "axe-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "axe-results.json: local test report artifacts must not be tracked for public launch",
        "axe-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "biome-report.html: local test report artifacts must not be tracked for public launch",
        "biome-report.json: local test report artifacts must not be tracked for public launch",
        "biome-report.xml: local test report artifacts must not be tracked for public launch",
        "biome-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "biome-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "biome-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "biome-results.json: local test report artifacts must not be tracked for public launch",
        "biome-results.xml: local test report artifacts must not be tracked for public launch",
        "biome-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "biome-results-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "markdownlint-junit.xml: local test report artifacts must not be tracked for public launch",
        "markdownlint-report.html: local test report artifacts must not be tracked for public launch",
        "markdownlint-report.json: local test report artifacts must not be tracked for public launch",
        "markdownlint-report.xml: local test report artifacts must not be tracked for public launch",
        "markdownlint-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "markdownlint-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "markdownlint-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "markdownlint-results.json: local test report artifacts must not be tracked for public launch",
        "markdownlint-results.xml: local test report artifacts must not be tracked for public launch",
        "markdownlint-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "markdownlint-results-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "proselint-junit.xml: local test report artifacts must not be tracked for public launch",
        "proselint-report.html: local test report artifacts must not be tracked for public launch",
        "proselint-report.json: local test report artifacts must not be tracked for public launch",
        "proselint-report.xml: local test report artifacts must not be tracked for public launch",
        "proselint-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "proselint-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "proselint-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "proselint-results.json: local test report artifacts must not be tracked for public launch",
        "proselint-results.xml: local test report artifacts must not be tracked for public launch",
        "proselint-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "proselint-results-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "remark-junit.xml: local test report artifacts must not be tracked for public launch",
        "remark-report.html: local test report artifacts must not be tracked for public launch",
        "remark-report.json: local test report artifacts must not be tracked for public launch",
        "remark-report.xml: local test report artifacts must not be tracked for public launch",
        "remark-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "remark-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "remark-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "remark-results.json: local test report artifacts must not be tracked for public launch",
        "remark-results.xml: local test report artifacts must not be tracked for public launch",
        "remark-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "remark-results-public-risk.xml: local test report artifacts must not be tracked for public launch",
        ...
        "codecov.json: local test report artifacts must not be tracked for public launch",
        "clover.xml: local test report artifacts must not be tracked for public launch",
        "client.coveralls.json: local test report artifacts must not be tracked for public launch",
        "coverage.clover.xml: local test report artifacts must not be tracked for public launch",
        "coverage.codecov.json: local test report artifacts must not be tracked for public launch",
        "cobertura.xml: local test report artifacts must not be tracked for public launch",
        "coverage.coveralls.json: local test report artifacts must not be tracked for public launch",
        "coverage.cobertura.xml: local test report artifacts must not be tracked for public launch",
        "ctrf-report.json: local test report artifacts must not be tracked for public launch",
        "ctrf-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        ...
        "jest-junit.xml: local test report artifacts must not be tracked for public launch",
        "jest-results.json: local test report artifacts must not be tracked for public launch",
        "jest_html_reporters.html: local test report artifacts must not be tracked for public launch",
        "eslint-junit.xml: local test report artifacts must not be tracked for public launch",
        "eslint-report.html: local test report artifacts must not be tracked for public launch",
        "eslint-report.json: local test report artifacts must not be tracked for public launch",
        "eslint-report.xml: local test report artifacts must not be tracked for public launch",
        "eslint-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "eslint-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "eslint-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "eslint-results.json: local test report artifacts must not be tracked for public launch",
        "eslint-results.xml: local test report artifacts must not be tracked for public launch",
        "eslint-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "eslint-results-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "stylelint-junit.xml: local test report artifacts must not be tracked for public launch",
        "stylelint-report.html: local test report artifacts must not be tracked for public launch",
        "stylelint-report.json: local test report artifacts must not be tracked for public launch",
        "stylelint-report.xml: local test report artifacts must not be tracked for public launch",
        "stylelint-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "stylelint-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "stylelint-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "stylelint-results.json: local test report artifacts must not be tracked for public launch",
        "stylelint-results.xml: local test report artifacts must not be tracked for public launch",
        "stylelint-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "stylelint-results-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "vitest-junit.xml: local test report artifacts must not be tracked for public launch",
        "vitest-report.html: local test report artifacts must not be tracked for public launch",
        "vitest-report.json: local test report artifacts must not be tracked for public launch",
        "vitest-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "vitest-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "vitest-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "vitest-results.json: local test report artifacts must not be tracked for public launch",
        ...
        "gotestsum.json: local test report artifacts must not be tracked for public launch",
        "gotestsum-report.xml: local test report artifacts must not be tracked for public launch",
        "services/api/go-test-report.json: local test report artifacts must not be tracked for public launch",
        "crates/fathom-core/go-test-results.xml: local test report artifacts must not be tracked for public launch",
        ...
        "junit-results.xml: local test report artifacts must not be tracked for public launch",
        ...
        "TESTS-fathom.xml: local test report artifacts must not be tracked for public launch",
        "crates/fathom-core/TESTS-fathom.xml: local test report artifacts must not be tracked for public launch",
        "testng-results.xml: local test report artifacts must not be tracked for public launch",
        "crates/fathom-core/testng-failed.xml: local test report artifacts must not be tracked for public launch",
        "emailable-report.html: local test report artifacts must not be tracked for public launch",
        ...
        "newman-report.html: local test report artifacts must not be tracked for public launch",
        "newman-report.json: local test report artifacts must not be tracked for public launch",
        "newman-report.xml: local test report artifacts must not be tracked for public launch",
        "robot-log.html: local test report artifacts must not be tracked for public launch",
        "robot-output.xml: local test report artifacts must not be tracked for public launch",
        "robot-report.html: local test report artifacts must not be tracked for public launch",
        "k6-report.html: local test report artifacts must not be tracked for public launch",
        "k6-report.json: local test report artifacts must not be tracked for public launch",
        "k6-summary.json: local test report artifacts must not be tracked for public launch",
        "k6-results.json: local test report artifacts must not be tracked for public launch",
        "k6-results.ndjson: local test report artifacts must not be tracked for public launch",
        "artillery-report.html: local test report artifacts must not be tracked for public launch",
        "artillery-report.json: local test report artifacts must not be tracked for public launch",
        "artillery-results.json: local test report artifacts must not be tracked for public launch",
        "locust-report.html: local test report artifacts must not be tracked for public launch",
        "locust_stats.csv: local test report artifacts must not be tracked for public launch",
        "locust_failures.csv: local test report artifacts must not be tracked for public launch",
        "locust_exceptions.csv: local test report artifacts must not be tracked for public launch",
        "tap-report.html: local test report artifacts must not be tracked for public launch",
        "tap-report.json: local test report artifacts must not be tracked for public launch",
        "tap-report.xml: local test report artifacts must not be tracked for public launch",
        "tap-report.tap: local test report artifacts must not be tracked for public launch",
        "tap-results.tap: local test report artifacts must not be tracked for public launch",
        "load-test.jtl: local test report artifacts must not be tracked for public launch",
        "crates/fathom-core/results.jtl: local test report artifacts must not be tracked for public launch",
        "crates/fathom-core/tap-report.json: local test report artifacts must not be tracked for public launch",
        ...
        ".report.json: local test report artifacts must not be tracked for public launch",
        "pytest-report.html: local test report artifacts must not be tracked for public launch",
        "pytest-report.json: local test report artifacts must not be tracked for public launch",
        "pytest-report.xml: local test report artifacts must not be tracked for public launch",
        "pytest-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "pytest-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "pytest-report-public-risk.xml: local test report artifacts must not be tracked for public launch",
        "crates/fathom-core/pytest-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "pa11y-ci-report.html: local test report artifacts must not be tracked for public launch",
        "pa11y-ci-report.json: local test report artifacts must not be tracked for public launch",
        "pa11y-ci-report.xml: local test report artifacts must not be tracked for public launch",
        "pa11y-ci-report-public-risk.json: local test report artifacts must not be tracked for public launch",
        "pa11y-ci-results.json: local test report artifacts must not be tracked for public launch",
        "pa11y-ci-results-public-risk.json: local test report artifacts must not be tracked for public launch",
        "pa11y-report.html: local test report artifacts must not be tracked for public launch",
        "pa11y-report.json: local test report artifacts must not be tracked for public launch",
        "pa11y-report.xml: local test report artifacts must not be tracked for public launch",
        "pa11y-report-public-risk.html: local test report artifacts must not be tracked for public launch",
        "pa11y-results.json: local test report artifacts must not be tracked for public launch",
        "pa11y-results-public-risk.json: local test report artifacts must not be tracked for public launch",
    ...
    security_scan_report_artifact_failures = tracked_security_scan_report_artifact_file_failures(
        tracked_paths=[
            ...
            "cargo-audit-report/advisories.json",
            "cargo-audit-reports/results.txt",
            "cargo-deny-report/bans.json",
            "cargo-deny-reports/licenses.txt",
            "codeql-database/db-python/db-python.trap.gz",
            "codeql-databases/javascript/db-javascript.trap.gz",
            "codeql-db/rust/db-rust.trap.gz",
            "codeql-dbs/cpp/db-cpp.trap.gz",
            ...
            "examples/web/cargo-audit-reports/results.json",
            "examples/web/cargo-deny-report/report.txt",
            ...
            "snyk-results.json",
            "cargo-audit-report.json",
            "cargo-audit-report-public-risk.txt",
            "cargo-audit-results.xml",
            "cargo-deny-report.json",
            "cargo-deny-report-public-risk.xml",
            "cargo-deny-results.txt",
            "codeql-report.json",
            "codeql-report-public-risk.json",
            "codeql-results.json",
            "codeql-results-public-risk.json",
            "npm-audit.json",
    ...
    if security_scan_report_artifact_failures != [
        ...
        "cargo-audit-report/advisories.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-audit-reports/results.txt: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-deny-report/bans.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-deny-reports/licenses.txt: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-database/db-python/db-python.trap.gz: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-databases/javascript/db-javascript.trap.gz: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-db/rust/db-rust.trap.gz: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-dbs/cpp/db-cpp.trap.gz: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-results/results.sarif: local security/dependency scan report artifacts must not be tracked for public launch",
        ...
        "examples/web/cargo-audit-reports/results.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "examples/web/cargo-deny-report/report.txt: local security/dependency scan report artifacts must not be tracked for public launch",
        ...
        "cargo-audit-report.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-audit-report-public-risk.txt: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-audit-results.xml: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-deny-report.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-deny-report-public-risk.xml: local security/dependency scan report artifacts must not be tracked for public launch",
        "cargo-deny-results.txt: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-report.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-report-public-risk.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-results.json: local security/dependency scan report artifacts must not be tracked for public launch",
        "codeql-results-public-risk.json: local security/dependency scan report artifacts must not be tracked for public launch",
